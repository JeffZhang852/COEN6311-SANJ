...
# Local import
from .forms import (
    ArticleForm, ChallengeForm, CustomUserCreationForm, IngredientFormSet,
    PrivacySettingsForm, ProfilePictureForm, RecipeForm, UpdateEmailForm, UpdatePasswordForm
)
from .models import (
    Article, Challenge, ChallengeParticipation, CoachAppointment, CoachAvailability,
    CoachReview, CustomUser, EquipmentList, Exercise, GymInfo, Message, Recipe,
    WorkoutPlan, WorkoutPlanExercise
)
from .serializers import CoachReviewSerializer, UserSerializer
...
def staff_user_detail(request, user_id):
    ...
    return render(request, "CUFitness/staff/user_detail.html", {"user_obj": user_obj})
