...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, email, password, date_of_birth=None, **extra_fields):
    ...
    def create_superuser(self, email, password, **extra_fields):
        ...
        extra_fields.setdefault("role", "ADMIN") # superuser created via createsuperuser gets the admin role
